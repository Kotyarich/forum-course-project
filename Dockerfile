...
RUN echo "temp_buffers = 64MB" >> /etc/postgresql/10/main/postgresql.conf
...
RUN echo "work_mem = 32MB" >> /etc/postgresql/10/main/postgresql.conf
RUN echo "checkpoint_segments = 6" >> /etc/postgresql/10/main/postgresql.conf
RUN echo "log_statement = 'none'" >> /etc/postgresql/10/main/postgresql.conf
