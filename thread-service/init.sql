...
CREATE TRIGGER add_root_id
  AFTER INSERT
  ON posts
  FOR EACH ROW
EXECUTE PROCEDURE init_post();
...
CREATE TRIGGER thread_insertion
  AFTER INSERT
  ON threads
  FOR EACH ROW
EXECUTE PROCEDURE inc_threads();

CREATE TRIGGER new_thread_author
  AFTER INSERT
  ON threads
  FOR EACH ROW
